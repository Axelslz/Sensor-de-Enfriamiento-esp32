...
#define FIREBASE_AUTH "https://esp32-187f5-default-rtdb.firebaseio.com/"
#define FIREBASE_HOST "AIzaSyAqJxDtcMcmXq97yijua9nX2lgtbMXGpyI"
...
void handleRoot() {
  ...
  <body>\
   <div class='container'>\
      ...
      <p>\
        <i class='fas fa-tint' style='color:#00add6;'></i>\
        <span class='dht-labels'>P. atmosferica</span>\
        <span>%.6f mmHg </span>\
        <sup class='units'>&percnt;</sup>\
      </p>\
      </div>\
